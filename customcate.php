...
$custom_order = array(
    'all' => array(
        'name' => 'All FAQ',
        'icon' => 'https://tradejini.com/wp-content/uploads/2023/08/Traced-Image-3.svg',
    ),
    'account-opening"' => array(
        'name' => 'Account Opening',
        'icon' => 'https://tradejini.com/wp-content/uploads/2023/08/Traced-Image-1.svg',
        'subcategories' => array(
            'general' => 'General',
    ...
    'pricing' => array(
        'name' => 'Pricing',
        'icon' => 'https://tradejini.com/wp-content/uploads/2023/08/Vector-5.svg',
    ),
    'technology' => array(
        'name' => 'Technology',
        'icon' => 'https://tradejini.com/wp-content/uploads/2023/08/Vector-6.svg',
        'subcategories' => array(
    ...
    'segments' => array(
        'name' => 'Segments',
        'icon' => 'https://tradejini.com/wp-content/uploads/2023/08/Vector-7.svg',
        'subcategories' => array(
            'equity' => 'Equity',
    ...
    'fund-transfer' => array(
        'name' => 'Fund Transfer',
        'icon' => 'https://tradejini.com/wp-content/uploads/2023/08/Vector-3.svg',
        'subcategories' => array(
            'pay-in' => 'Pay In',
            'pay-out' => 'Pay Out',
        )
    ...
    'margins' => array(
        'name' => 'Margins',
        'icon' => 'https://tradejini.com/wp-content/uploads/2023/08/Vector-4.svg',
    ),
    'order-types' => array(
        'name' => 'Order Types',
        'icon' => 'https://tradejini.com/wp-content/uploads/2023/08/Order-Types.svg',
        
    ),
    'settlement-cycles' => array(
        'name' => 'Settlement Cycles',
        'icon' => 'https://tradejini.com/wp-content/uploads/2023/08/Vector-8.svg',
        
    ),
    'ipo' => array(
        'name' => 'IPO',
        'icon' => 'https://tradejini.com/wp-content/uploads/2023/08/IPO.svg',
       
    ),
    'account-details' => array(
        'name' => 'Account Details',
        'icon' => 'https://tradejini.com/wp-content/uploads/2023/08/Subtract.svg',
...
foreach ($custom_order as $category_slug => $category_data) {
    echo '<li class="faq-category">';
    echo '<a href="#" class="category-toggle" data-category="' . $category_slug . '">';

    // Display the category icon
    if ($category_data['icon']) {
        echo '<img src="' . esc_url($category_data['icon']) . '" alt="" class="category-icon" />';
    }

    echo $category_data['name'] . '</a>';

    if (!empty($category_data['subcategories'])) {
        echo '<ul class="faq-subcategories">';
        foreach ($category_data['subcategories'] as $subcategory_slug => $subcategory_name) {
            echo '<li class="faq-subcategory">';
            echo '<a href="#" data-category="' . $subcategory_slug . '">' . $subcategory_name . '</a>';
            echo '</li>';
        }
        echo '</ul>';
    }
